...
namespace smart_home {
    ...
    public:
        ...
        void removeTemperatureSensor(const std::string& name);
        void removeHumiditySensor(const std::string& name);
        void removeMonoxideSensor(const std::string& name);
        std::string displaySensorStatuses() const;
